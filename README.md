...
Centaurus es un proyecto académico que simula la batalla entre los ejércitos del Bien y del Mal en el universo de Centauro. Incluye una interfaz de consola, una interfaz gráfica basada en Tkinter y una pista opcional de música retro reproducida con `pygame`.
